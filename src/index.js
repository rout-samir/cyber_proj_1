import { analyzeWithGemini, GeminiError } from './gemini.js';
...
async function handleUpload(request, env) {
    ...
    try {
        ...
        try {
            ...
            analysis = await analyzeWithGemini(fileContent, env.GEMINI_API_KEY);
        } catch (error) {
        ...
        // If analysis is successful, store it in D1
        ...
        if (!success) {
            // Log the error, but the user has already received the analysis
